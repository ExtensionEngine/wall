...
internals.authenticate = function(request, reply) {
  if (!internals.isAuthenticated(request)) {
    ...
    if (headers['x-requested-with'] === 'XMLHttpRequest' ||
      ...
      return internals.sendUnauthorized(request, reply);
    }

    return reply.redirect(internals.loginForm);
  }
...
exports.getSession = internals.getSession = function(request) {
  return request.yar;
};

exports.getAuthentication = internals.getAuthentication = function(request) {
